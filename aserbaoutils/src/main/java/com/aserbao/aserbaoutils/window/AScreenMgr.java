package com.aserbao.aserbaoutils.window;
...
public class AScreenMgr {
    ...
    public static int getNavigationAreaHeight(Context context) {
        int realScreenHeight = AScreenMgr.getRealScreenHeight(context);
        int screenHeight = AScreenMgr.getScreenHeight(context);
    ...
    public static String shoot(Activity a) {
        ...
        boolean ret = AScreenMgr.savePic(AScreenMgr.takeScreenShot(a), localPath);
        if (ret) {
            return localPath;
        } else {
            return "";
    ...
    public static String shootWebView(Context context, WebView webView) {
        ...
        boolean ret = AScreenMgr.savePic(AScreenMgr.captureWebView(webView), localPath);
        if (ret) {
            return localPath;
        } else {
            return "";
