...
import com.aserbao.aserbaoutils.R;
/**
 * description:
 * Created by aserbao on 2017/9/18.
 */
public class AStatusBarUtil {

    public static final int DEFAULT_STATUS_BAR_ALPHA = 112;
    private static final int FAKE_STATUS_BAR_VIEW_ID = R.id.a_status_bar_view;
    private static final int FAKE_TRANSLUCENT_VIEW_ID = R.id.a_translucent_view;
