...
public class CoordinatorLayout3Activity extends AppCompatActivity
    ...
    private void bindActivity() {
        mToolbar        = (Toolbar) findViewById(R.id.coord3_toolbar);
        mTitle          = (TextView) findViewById(R.id.coord3_textview_title);
        mTitleContainer = (LinearLayout) findViewById(R.id.coord3_linearlayout_title);
        mAppBarLayout   = (AppBarLayout) findViewById(R.id.coord3_appbar);
    }
