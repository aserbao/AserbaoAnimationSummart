 ...
 */
public class StarHVScrollView extends FrameLayout {
    ...
    private float fromXOne, fromXTwo, fromXThree;

    private float fromYOne, fromYTwo, fromYThree;

    private float beginYOne;
    private float beginYTwo;
    private float beginYThree;
    ...
    public StarHVScrollView(Context context) {
        this(context, null);
        mContext = context;
        initScrollView();
    }

    public StarHVScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initScrollView();
    }
...
//        beginYThree = 0;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                Log.e("StarHVScrollView","StarHVScrollView滑动");
...
//                    loadStarsAnim(deltaX, deltaY);            //加载星星动画
...
//    private void loadStarsAnim(float deltalX, float deltalY) {
//
//        if (deltalY == 0) {
//            return;
//        }
//
//        //获取星球对象
//        homeMailList = (ImageView) ((HomePageActivity) mContext).findViewById(R.id.home_maillist);
//        homeQiuhuan = (ImageView) ((HomePageActivity) mContext).findViewById(R.id.home_qiuhuan);
//        homeRankingList = (ImageView) ((HomePageActivity) mContext).findViewById(R.id.home_rankingList);
//        //星球动画
//        int scrollX = getScrollX();
//        int scrollY = getScrollY();
//        float scaleOne, scaleTwo, scaleThree;
//        int distance;
//
//        //垂直滑动
//        distance = 2600 - scrollY;
//
//        if (distance > 0) {           //放大
//            Log.e("HVScrollView", "放大");
//            scaleOne = 1 + (float) distance / mHeidht * 6;
//            scaleTwo = 1 + (float) distance / mHeidht * 4;
//            scaleThree = 1 + (float) distance / mHeidht * 2;
//        } else {                    //缩小
//            Log.e("HVScrollView", "缩小");
//            scaleOne = 1 + (float) distance / (mHeidht * 6);
//            scaleTwo = 1 + (float) distance / (mHeidht * 4);
//            scaleThree = 1 + (float) distance / (mHeidht * 2);
//        }
...
//
//        //创建动画集合
//        AnimationSet animationSetOne = new AnimationSet(true);
//        AnimationSet animationSetTwo = new AnimationSet(true);
//        AnimationSet animationSetThree = new AnimationSet(true);
//
//        animationSetOne.setFillAfter(false);
//        animationSetTwo.setFillAfter(false);
//        animationSetThree.setFillAfter(false);
//
//
////        //创建位移动画
////        Animation animationTransOne = new TranslateAnimation(0, 0, 0, distance);
////        Animation animationTransTwo = new TranslateAnimation(0, 0, 0, distance / 2);
////        Animation animationTransThree = new TranslateAnimation(0, 0, 0, distance / 4);
////
////        animationTransOne.setFillAfter(true);//设置为true，动画转化结束后被应用
////        animationTransTwo.setFillAfter(true);//设置为true，动画转化结束后被应用
////        animationTransThree.setFillAfter(true);//设置为true，动画转化结束后被应用
//
//        //创建缩放动画
...
//                Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
//
//        animationOne.setFillAfter(false);
//        animationTwo.setFillAfter(false);
//        animationThree.setFillAfter(false);
//
//        //将动画放入动画集中
//        animationSetOne.addAnimation(animationOne);
////        animationSetOne.addAnimation(animationTransOne);
//        animationSetTwo.addAnimation(animationTwo);
////        animationSetTwo.addAnimation(animationTransTwo);
//        animationSetThree.addAnimation(animationThree);
////        animationSetThree.addAnimation(animationTransThree);
//
//        animationSetOne.setFillAfter(true);
//        animationSetTwo.setFillAfter(true);
//        animationSetThree.setFillAfter(true);
//
//        homeMailList.setAnimation(animationSetOne);
//        homeQiuhuan.setAnimation(animationSetTwo);
//        homeRankingList.setAnimation(animationThree);
//        /** 开始动画 */
//
//
//        fromXOne = scaleOne;
